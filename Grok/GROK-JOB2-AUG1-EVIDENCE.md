...
| **total** | **586** | **131 on page** (27+30+36+38) | **7** | **1** | **454 on page** | GRASS 57 of leftover are skip |
...
- Did not start over. Spliced already-proved LOCKIN first, then walked remaining live coins in order.
...
- `index-v4.html` — siren-watch-data for FART (batch 1, left alone after), LOCKIN, RETARDIO, SPX. JS row from batch 1.
...
- Batch 4: this commit (SPX 38). Hash: read `git log -1`.

## Status

**NOT DONE.** Live remaining: 2Z (walking), IO, RENDER, BONK, NOS, GIGA. GRASS skipped. Honest DEFERs left as_of_now: FART 3, LOCKIN Raydium, RETARDIO Raydium, SPX Orca Whirlpool + Raydium. Grok has not marked this complete.
