...
PATCHES = {
    "hype.af.buys.usd.30d": {
        ...
        "provider": "DefiLlama",
        "endpoint_or_method": "/overview/fees?dataType=dailyHoldersRevenue",
        "selector": {
            "type": "named_record_field",
            "name": "defillama_hyperliquid_holders_revenue_30d",
            "identity": {"name": "Hyperliquid"},
            "field": "total30d",
        },
    ...
    "render.emissions.tokens.remaining": {
        ...
        "endpoint_or_method": "official dashboard / Leftover Emissions",
        "selector": {
            "type": "explicit_html_selector",
            "name": "render_leftover_emissions",
            "label": "Leftover Emissions",
        },
        "normalizer": {"type": "identity"},
        "derivation": None,
        "decision_reason": (
