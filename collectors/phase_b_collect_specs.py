...
_c('hype.af.buys.usd.30d',
    ...
    derivation=None,
    source_key='defillama',
    request_key='defillama.overview.fees.dailyHoldersRevenue',
    selector={'type': 'named_record_field', 'name': 'defillama_hyperliquid_holders_revenue_30d', 'identity': {'name': 'Hyperliquid'}, 'field': 'total30d', 'data_type': 'dailyHoldersRevenue'},
    normalizer={'type': 'identity'},
    notes='CGPT Job 2B: overview fees dailyHoldersRevenue; identity name=Hyperliquid exact; field total30d.',
)
...
_c('render.bme.node_due.tokens.per_epoch',
    ...
    selector={'type': 'named_record_field', 'name': 'epoch_burn_latest_field', 'field': 'latest_node_operator_due'},
    normalizer={'type': 'identity'},
    notes='V3 render_stage1_loader bme.node_operator_due_per_epoch.',
)
...
_c('render.bme.ratio.last4',
    ...
    source_key='render_foundation',
    request_key='render.epochBurnStats',
    selector={'type': 'named_record_field', 'name': 'bme_burn_emit_ratio_last_n', 'n': 4},
    normalizer={'type': 'identity'},
    notes='V3 render_stage1_loader bme.last4.ratio.',
)
...
_c('render.bme.ratio.last8',
    ...
    source_key='render_foundation',
    request_key='render.epochBurnStats',
    selector={'type': 'named_record_field', 'name': 'bme_burn_emit_ratio_last_n', 'n': 8},
    normalizer={'type': 'identity'},
    notes='V3 render_stage1_loader bme.last8.ratio.',
)
...
_c('render.emissions.tokens.remaining',
    ...
    derivation=None,
    source_key='render_foundation',
    request_key='render.dashboard.main',
    selector={'type': 'explicit_html_selector', 'name': 'render_leftover_emissions', 'label': 'Leftover Emissions'},
    normalizer={'type': 'identity'},
    notes='CGPT Job 2B: render.dashboard.main html selector render_leftover_emissions label Leftover Emissions.',
)
